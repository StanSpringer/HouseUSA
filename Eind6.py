...
page = st.sidebar.radio("Inhoudsopgave", ['Sectie 1', 'Sectie 2', 'Sectie 3'])
...
fig.add_trace(go.Scatter(x=avg_price_per_year["yr_built"], y=avg_price_per_year["price"], mode='lines', name='Dataframe 1', line=dict(color='salmon')))
